...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Timesheet], { name: "timesheets" })
  @nestAccessControl.UseRoles({
    resource: "Timesheet",
    action: "read",
    possession: "any",
  ...
  async findTimesheets(
    ...
    const results = await this.service.findTimesheets(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [VacationPolicy], { name: "vacationPolicies" })
  @nestAccessControl.UseRoles({
  ...
  async findVacationPolicies(
    ...
    const results = await this.service.findVacationPolicies(parent.id, args);
